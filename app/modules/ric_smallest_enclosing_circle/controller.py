...
def parse_form(data: Mapping[str, str]) -> Tuple[RicForm, Dict[str, str]]:
    defaults = RicForm()
    errors: Dict[str, str] = {}

    n_points = max(3, min(1000, _parse_int(data.get("n_points", ""), defaults.n_points)))
